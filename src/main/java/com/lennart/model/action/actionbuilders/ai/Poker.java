    ...
    public String getAction(ActionVariables actionVariables, List<String> eligibleActions, String street, boolean position, double potSizeBb, String opponentAction,
        ...
        try {
            ...
            if(!routeDataIsBigEnough(routeData, eligibleActions)) {
                ...
                action = ruleApplier.moderateBluffRaises(action, actionVariables, eligibleActions, street, position, potSizeBb, opponentAction, facingOdds, effectiveStackBb, strongDraw, handStrength, opponentType, opponentBetSizeBb, ownBetSizeBb, opponentStackBb, ownStackBb, preflop, board, strongFlushDraw, strongOosd, strongGutshot, bigBlind, opponentDidPreflop4betPot, pre3betOrPostRaisedPot, strongOvercards, strongBackdoorFd, strongBackdoorSd, boardWetness, opponentHasInitiative);
                action = ruleApplier.moderateGutshotRaises(action, actionVariables, eligibleActions, street, position, potSizeBb, opponentAction, facingOdds, effectiveStackBb, strongDraw, handStrength, opponentType, opponentBetSizeBb, ownBetSizeBb, opponentStackBb, ownStackBb, preflop, board, strongFlushDraw, strongOosd, strongGutshot, bigBlind, opponentDidPreflop4betPot, pre3betOrPostRaisedPot, strongOvercards, strongBackdoorFd, strongBackdoorSd, boardWetness, opponentHasInitiative);
                action = ruleApplier.valueBet(action, handStrength, opponentType, preflop, street, position);
                action = ruleApplier.valueBetInPosition(action, handStrength, position, board);
                ...
                action = ruleApplier.moderateRaisesBasedOnEquity(action, actionVariables, eligibleActions, street, position, potSizeBb, opponentAction, facingOdds, effectiveStackBb, strongDraw, handStrength, opponentType, opponentBetSizeBb, ownBetSizeBb, opponentStackBb, ownStackBb, preflop, board, strongFlushDraw, strongOosd, strongGutshot, bigBlind, opponentDidPreflop4betPot, pre3betOrPostRaisedPot, strongOvercards, strongBackdoorFd, strongBackdoorSd, boardWetness, opponentHasInitiative);
                action = ruleApplier.moderateOverbetCalls(action, opponentAction, potSizeBb, opponentBetSizeBb, handStrength, actionVariables.getHandEvaluator());
...
//        routeData.put("raise_payoff", Math.random());
    ...
    private void initializeDbConnection() throws Exception {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/poker?&serverTimezone=UTC", "root", "");
    }
