...
public class Call3bet {
    ...
    public Call3bet(ActionBuilderUtil p) {
        ...
        //new
        comboMap100Percent.put(4, p.getOffSuitCombosOfGivenRanks(14, 8));
        comboMap100Percent.put(5, p.getOffSuitCombosOfGivenRanks(13, 10));
        comboMap100Percent.put(6, p.getOffSuitCombosOfGivenRanks(12, 9));
        comboMap100Percent.put(7, p.getOffSuitCombosOfGivenRanks(11, 9));
        comboMap100Percent.put(8, p.getOffSuitCombosOfGivenRanks(10, 9));
        comboMap100Percent.put(9, p.getOffSuitCombosOfGivenRanks(9, 8));
        comboMap100Percent.put(10, p.getOffSuitCombosOfGivenRanks(8, 7));
        comboMap100Percent.put(11, p.getSuitedCombosOfGivenRanks(13, 7));
        comboMap100Percent.put(12, p.getSuitedCombosOfGivenRanks(12, 7));
        comboMap100Percent.put(13, p.getSuitedCombosOfGivenRanks(11, 7));
        comboMap100Percent.put(14, p.getSuitedCombosOfGivenRanks(10, 7));
        comboMap100Percent.put(15, p.getSuitedCombosOfGivenRanks(13, 6));
        comboMap100Percent.put(16, p.getSuitedCombosOfGivenRanks(9, 6));
        comboMap100Percent.put(17, p.getSuitedCombosOfGivenRanks(8, 5));
        comboMap100Percent.put(18, p.getPocketPairCombosOfGivenRank(5));
        comboMap100Percent.put(19, p.getSuitedCombosOfGivenRanks(7, 4));
        comboMap100Percent.put(20, p.getPocketPairCombosOfGivenRank(4));
        ...
        comboMap50Percent.put(4, p.getOffSuitCombosOfGivenRanks(14, 7));
        comboMap50Percent.put(5, p.getOffSuitCombosOfGivenRanks(14, 6));
        comboMap50Percent.put(6, p.getOffSuitCombosOfGivenRanks(14, 5));
        comboMap50Percent.put(7, p.getOffSuitCombosOfGivenRanks(14, 4));
        comboMap50Percent.put(8, p.getOffSuitCombosOfGivenRanks(14, 3));
        comboMap50Percent.put(9, p.getOffSuitCombosOfGivenRanks(14, 2));
        comboMap50Percent.put(10, p.getOffSuitCombosOfGivenRanks(13, 9));
        comboMap50Percent.put(11, p.getOffSuitCombosOfGivenRanks(12, 8));
        comboMap50Percent.put(12, p.getOffSuitCombosOfGivenRanks(11, 8));
        comboMap50Percent.put(13, p.getOffSuitCombosOfGivenRanks(10, 8));
        comboMap50Percent.put(14, p.getOffSuitCombosOfGivenRanks(9, 7));
        comboMap50Percent.put(15, p.getOffSuitCombosOfGivenRanks(8, 6));
        comboMap50Percent.put(16, p.getOffSuitCombosOfGivenRanks(7, 6));
        comboMap50Percent.put(17, p.getSuitedCombosOfGivenRanks(12, 6));
        comboMap50Percent.put(18, p.getSuitedCombosOfGivenRanks(11, 6));
        comboMap50Percent.put(19, p.getSuitedCombosOfGivenRanks(10, 6));
        comboMap50Percent.put(20, p.getSuitedCombosOfGivenRanks(13, 5));
        comboMap50Percent.put(21, p.getSuitedCombosOfGivenRanks(12, 5));
        comboMap50Percent.put(22, p.getSuitedCombosOfGivenRanks(11, 5));
        comboMap50Percent.put(23, p.getSuitedCombosOfGivenRanks(9, 5));
        comboMap50Percent.put(24, p.getSuitedCombosOfGivenRanks(13, 4));
        comboMap50Percent.put(25, p.getSuitedCombosOfGivenRanks(12, 4));
        comboMap50Percent.put(26, p.getSuitedCombosOfGivenRanks(8, 4));
        comboMap50Percent.put(27, p.getSuitedCombosOfGivenRanks(13, 3));
        comboMap50Percent.put(28, p.getSuitedCombosOfGivenRanks(12, 3));
        comboMap50Percent.put(29, p.getSuitedCombosOfGivenRanks(7, 3));
        comboMap50Percent.put(30, p.getSuitedCombosOfGivenRanks(6, 3));
        comboMap50Percent.put(31, p.getPocketPairCombosOfGivenRank(3));
        comboMap50Percent.put(32, p.getSuitedCombosOfGivenRanks(13, 2));
        comboMap50Percent.put(33, p.getSuitedCombosOfGivenRanks(5, 2));
        comboMap50Percent.put(34, p.getPocketPairCombosOfGivenRank(2));
        comboMap50Percent.put(35, p.getOffSuitCombosOfGivenRanks(6, 5));
        comboMap50Percent.put(36, p.getOffSuitCombosOfGivenRanks(5, 4));
        comboMap50Percent.put(37, p.getOffSuitCombosOfGivenRanks(4, 3));

        comboMap34Percent.put(1, p.getOffSuitCombosOfGivenRanks(7, 5));
        comboMap34Percent.put(2, p.getOffSuitCombosOfGivenRanks(5, 3));
