 ...
 */
public class SimulatedHandTest {
    ...
    public SimulatedHandTest(int numberOfHandsPlayed) {
        SimulatedHandTest.numberOfHandsPlayed++;
    ...
    private void setDummyAction(String bot) {
        if(bot.equals("aiBot")) {
            if(SimulatedHandTest.numberOfHandsPlayed > 15000) {
